...
urlpatterns = [
    ...
    path("login_user/doLogin/", views.doLogin, name='user_login'),
    ...
    path("applicants_list", hod_views.applicants_list,
    ...
    path('student/view/fees/', student_views.student_view_fees,name='student_view_fees'),
     path('student/view/units/', student_views.student_view_units,name='student_view_units'),
   path('student/view/academics/', student_views.student_view_academics,name='student_view_academics'),
